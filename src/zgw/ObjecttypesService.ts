...
export class ObjecttypesService extends ComposedZgwService {
  ...
  getEnvironmentConfiguration() {
    const environment = {
      ...
      CACHE_DEFAULT: this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCachePathObjectsTypes,
      CACHE_AXES: this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCachePathObjectsTypes,
      SUBPATH: '/objecttypes',
      IS_HTTPS: 'True',
