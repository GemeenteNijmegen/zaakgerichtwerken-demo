...
export class ObjectsService extends ComposedZgwService {
  ...
  constructor(scope: Construct, id: string, props: ObjectsServiceProps) {
    ...
    this.registerZgwService(
      ...
      new ZgwService(this, 'objects', {
        containerImage: 'maykinmedia/objects-api@sha256:64dd10943b29e1a48f8f52d647181584b2921c5b38898e2c667876bf11c570d3',
  ...
  getEnvironmentConfiguration() {
    const environment = {
      ...
      CACHE_DEFAULT: this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCachePathObjects,
      CACHE_AXES: this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCachePathObjects,
      SUBPATH: '/objects',
      IS_HTTPS: 'True',
      ...
      // Celery
      CELERY_BROKER_URL: 'redis://'+this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCeleryPathObjects,
      CELERY_RESULT_BACKEND: 'redis://'+this.props.zgwCluster.redis.redisCluster.attrRedisEndpointAddress + ':' + this.props.zgwCluster.redis.redisCluster.attrRedisEndpointPort + Statics.redisCeleryPathObjects,
